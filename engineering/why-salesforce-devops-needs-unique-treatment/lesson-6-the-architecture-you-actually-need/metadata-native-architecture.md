...
<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Component-aware version control</strong></td><td>Metadata stored as typed objects with identity and relationship graphs, not serialized XML files indexed by path.</td><td><a href="metadata-native-architecture.md#requirement-1-component-aware-version-control">#requirement-1-component-aware-version-control</a></td></tr><tr><td><strong>Semantic merge engine</strong></td><td>Merge performed by comparing component state semantically: resolves permission set conflicts by grant semantics, not XML structure.</td><td><a href="metadata-native-architecture.md#requirement-2-semantic-merge-engine">#requirement-2-semantic-merge-engine</a></td></tr><tr><td><strong>Org-aware deployment</strong></td><td>Pre-deployment org state query, overwrite detection, validation against live dependency graph before any write to the org.</td><td><a href="metadata-native-architecture.md#requirement-3-org-aware-deployment">#requirement-3-org-aware-deployment</a></td></tr><tr><td><strong>First-class backup and rollback</strong></td><td>Full org snapshot before each deployment. Restore is a first-class operation with predictable completion time, not manual reconstruction.</td><td><a href="metadata-native-architecture.md#requirement-4-first-class-backup-and-rollback">#requirement-4-first-class-backup-and-rollback</a></td></tr><tr><td><strong>Compliance-native audit trail</strong></td><td>Approval chain, deployment authorization, out-of-pipeline change detection. Retention configurable to SOX/HIPAA/GDPR requirements.</td><td><a href="metadata-native-architecture.md#requirement-5-compliance-native-audit-trail">#requirement-5-compliance-native-audit-trail</a></td></tr><tr><td><strong>Platform-native security model</strong></td><td>Data residency and access control via Salesforce's own security model: permissions, revocations, and data residency governed by the platform.</td><td><a href="metadata-native-architecture.md#requirement-6-platform-native-security-model">#requirement-6-platform-native-security-model</a></td></tr></tbody></table>
